CREATE DATABASE IF NOT EXISTS stavex CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS donations (
  ...
  currency VARCHAR(16) NOT NULL DEFAULT 'dkk',
  created_at DATETIME NOT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY uniq_event (stripe_event_id),
  UNIQUE KEY uniq_payment (stripe_payment_intent_id),
  KEY idx_donations_discord_user (discord_user_id)
